...
export default function Graph(props: any) {
    const measurements = useSelector((state: {data: any}) => state.data);
    const selectedGraph = useSelector((state : { selectedMetrics: any}) => state.selectedMetrics);

    const time = () => {
        const times: any = [];
        measurements.flareTemp.map((flareReadings: any) => {
    ...
    const dataHandler = () => {
        ...
        if (selectedGraph.includes("flareTemp")) {
            const values: any = [];
            measurements.flareTemp.map((measurement: any) => {
        ...
        if (selectedGraph.includes("waterTemp")) {
            const values: any = [];
            measurements.waterTemp.map((measurement: any) => {
                return values.push(measurement.value);
            });
            dataSets.push({
                label: "Water (°F)",
        ...
        if (selectedGraph.includes("oilTemp")) {
            const values: any = [];
            measurements.oilTemp.map((measurement: any) => {
                return values.push(measurement.value);
            });
            dataSets.push({
                label: "Oil (°F)",
        ...
        if (selectedGraph.includes("casingPressure")) {
            const values: any = [];
            measurements.casingPressure.map((measurement: any) => {
                return values.push(measurement.value);
            });
            dataSets.push({
                label: "Casing (PSI)",
        ...
        if (selectedGraph.includes("tubingPressure")) {
            const values:any = [];
            measurements.tubingPressure.map((measurement:any) => {
                return values.push(measurement.value);
            });
            dataSets.push({
                label: "Tubing (PSI)",
        ...
        if (selectedGraph.includes("injValveOpen")) {
            const values: any = [];
            measurements.injValveOpen.map((measurement:any) => {
                return values.push(measurement.value);
            });
            dataSets.push({
